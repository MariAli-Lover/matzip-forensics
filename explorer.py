    ...
    while(True) : #무한반복
        ...
        if cmd == "ls" :
            ...
            for i in row_evidences :
                ...
                main.printDebugMessage("file_node : " + str(i[11]))
            print("\n")
        ...
        if cmd[:2] == "cd" : # 앞 두글자가 cd이면
            ...
            if dir_name == ".." : #상위폴더
                ...
                main.default_path = row_result[2] + "/" + row_result[1] if row_result[2] != "/" else "/"+row_result[1] #"# C:\test> 같은거, 앞에 // 되는거 막기위해 3항연산자씀
