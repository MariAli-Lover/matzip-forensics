...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.itemView.setItem(0, 0, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.itemView.verticalHeaderItem(0)
        ...
        __sortingEnabled = self.itemView.isSortingEnabled()
        self.itemView.setSortingEnabled(False)
        item = self.itemView.item(0, 0)
        item.setText(_translate("MainWindow", "sd"))
        self.itemView.setSortingEnabled(__sortingEnabled)
